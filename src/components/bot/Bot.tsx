  ...
  React.useEffect(() => {
    ...
    script.onload = () => {
      window.botpressWebChat.init({
        ...
        botName: "Techspace",
        avatarUrl:
          "https://www.shutterstock.com/image-vector/chatbot-icon-concept-chat-bot-600nw-2132342911.jpg",
        phoneNumber: "+977-9825506216",
        termsConditions: "do not use for illegal works",
        emailAddress: "developersaroj326@gmail.com",
        stylesheet:
          "https://webchat-styler-css.botpress.app/prod/37832093-bb93-48b9-980a-795966b085a9/v45618/style.css",
        frontendVersion: "v1",
