  ...
  return (
    <div className="flex  sm:flex-row  flex-col  ">
      <div className="flex sm:w-1/2 flex-col  bg-[#111111]  sm:py-[100px] px-[80px] py-[50px] gap-[50px] sm;gap-[10px]">
        <h4 className="text-[40px] mb-[10px] font-mono text-white"> BLog & Articles</h4>
        <div>
      ...
      <div className="flex flex-col sm:w-1/2   gap-[50px] bg-[#1f2020] sm:py-[100px] justify-between items-baseline sm:px-[100px] p-[10px]">
              ...
              <h3 className="sm:text-[20px]  text-white font-mono">Subscribe to my newsletter today</h3>
        <span className="sm:text-[17px] text-[13px]  text-[#adabab]">
          ...
          nisi modi, accusamus maxime dignissimos sit!
              ...
              <form action="" className="flex flex-col gap-[15px] items-baseline">
                  <label htmlFor="">
                      <input className="outline-none text-white bg-[#1B1F24] py-[7px] px-[7px] border-b-8   "  type="email" placeholder="Your email address"></input>
                  </label>
                  <button className="outline-none text-[white] flex gap-[10px] hover:gap-[15px] transition-all">subscribe now <ArrowForwardIcon className="text-[#FFFF00]"/></button>
              </form>
      </div>
    </div>
  );
